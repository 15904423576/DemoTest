...
public class DemoTest2 {
    ...
    public void method910(){
        String s = AESUtils.decrypt("ABCAC1BEC82571571798CAEAB25CC0A13372D7BC6B97962C6FD50095DBB69962","BD41CC377A72CDDD2EC3542730023D1B");
                System.out.println(s);
        String ss = AESUtils.encrypt("424006195411103735", "BD41CC377A72CDDD2EC3542730023D1B");
...
*/
       /*String s = String.format("%s","nihaos");
       System.out.println(s);
       System.out.printf("ade:%s",'a');
*/
        ...
        System.out.println(s);
        //
        //  System.out.println(String.format("年-月-如格式：%tF%n",new Date()));
    ...
    @Test
    public void meetho() {
        List<String> list = Arrays.asList("oo", "aa", "bb", "cc");
        list.sort((a, b) -> a.compareTo(b));
        list.forEach(e -> System.out.println(e));
        System.out.println("--------------------------");
        list.stream().sorted((a, b) -> a.compareTo(b)).forEach(e -> System.out.println(e));
